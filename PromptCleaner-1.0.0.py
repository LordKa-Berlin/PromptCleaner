#Programname: PromptCleaner
#  Datum: 31.03.2025
# Versionsnummer
version = "1.0.0"
# Zusammenfassung: Dieses Skript erstellt ein GUI namens 'PromptCleaner' zur Entfernung spezifischer Zeichen aus Text 
# (Zahlen, Punkte, Doppelpunkte vor Klammern und Klammern selbst) für KI-Bildgenerierungsprompts. Es unterstützt 
# Clipboard-Operationen, Transparenzanpassung, "Always on Top"-Funktion und Drag-and-Drop. 
# Neu in v1.0.2: Fehler 'selfBrokerage' (Tippfehler) behoben, vorhergehender Fehler 'keep_on_top_var' bereits in v1.0.1 gefixt.
...
class CharacterRemoverApp:
    def __init__(self, root):
        self.root = root
        self.root.title("PromptCleaner")  # Titel auf PromptCleaner gesetzt
        ...
        # "Always on Top" Variable vor create_widgets definieren
        self.keep_on_top_var = tk.BooleanVar(value=False)

        # Create widgets
        self.create_widgets()

        # Initialize the "Always on Top" status
    ...
    def create_widgets(self):
        ...
        self.top_frame = tk.Frame(self.root, bg="#1F1F1F")  # Korrektur: selfBrokerage entfernt
